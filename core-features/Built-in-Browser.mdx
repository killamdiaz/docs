...
- **Header Bar**
  ...
  - **Chat Button**: Enables integrated chat support.
  - **Notifications (Bell Icon)**: Displays alerts and updates.
  - **Workspace Selector**: Access and switch between multiple workspaces.
  - **Theme/Mode Toggle**: Located at the far right for dark/light or focus view.
- **Favorites Section**
  ...
  - **Quick Actions**
    ...
    5. 🔖 R**Bookmark** – Save the page for quick access later.
  - **Integration**
